...
class AutoEncoder(nn.Module):
    ...
    def decode(self, z: Tensor) -> Tensor:
        ...
        print(self.scale_factor,self.shift_factor,z.dtype)
...
class VideoVAE(nn.Module):
    ...
    def encode(self, x: Tensor) -> Tensor:
        z=self.encoder.encode(x.unsqueeze(2))[0].squeeze(2)
        return z

    def decode(self, z: Tensor) -> Tensor:
        # import pdb
        # pdb.set_trace()
        return self.decoder.decode(z.cuda().to(dtype=torch.bfloat16).unsqueeze(2)).squeeze(2)
